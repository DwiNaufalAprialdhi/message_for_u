        ...
        <div className='w-full h-full min-h-screen md:max-w-[480px] max-w-none md:mx-auto mx-0 bg-[#f0e6e6] px-5 pt-5 pb-[120px] overflow-x-hidden'>
          ...
          <div className='w-full grid grid-cols-1 mb-2'>
            ...
            >
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/desember/D1.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/desember/D2.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/desember/D3.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/desember/D4.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/desember/D5.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/desember/D6.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
            </Swiper>
          </div>
          ...
          <div className='w-full grid grid-cols-1 mb-2'>
            ...
            >
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-1.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-2.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-3.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-4.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-5.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-6.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-7.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-8.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-9.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-10.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-11.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/januari/J-12.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
            </Swiper>
          </div>
          ...
          <div className='w-full grid grid-cols-1 mb-2'>
            ...
            >
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-1.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-2.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-3.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-4.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-5.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-6.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-7.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-8.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-9.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-10.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-11.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-12.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-13.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-14.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-15.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-16.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-17.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-18.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
                  <Image src={`/februari/F-19.png`} alt="carousel" width={500} height={500} className='w-full h-full object-cover' />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='w-full h-max rounded-[8px] overflow-hidden'>
